...
* 04 *Draw a dot* - Try to draw a 10 pixel large red dot on a black background. Note that point size, location and color are controlled in the shaders, not in the python source. 
