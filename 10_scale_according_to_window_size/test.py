...
from PyQt5.QtGui import QOpenGLShaderProgram, QOpenGLShader, QVector4D
...
class TestCanvas(Canvas):
    ...
    def setupGL(self):
        ...
        # Bind the shader "uniform" for controling the scale of the vertex positions
        self.scaling = self.gl.glGetUniformLocation(self.program.programId(), "scaling")
    ...
    def paintGL(self):
        ...
        self.program.setUniformValue(self.scaling, self.currentScaling)
