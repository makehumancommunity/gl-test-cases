# Taken from https://github.com/Somsubhra/pyOpenGL-Samples (with do what the
# you want license). Updated for python3 compatibility.
...
def main():
    ...
    if sys.version_info >= (3, 0):
        glutCreateWindow(bytes("Cube",'utf-8'))
    else:
